// Code generated by ts-to-go at 48f0b3cc383bfd6337fc9b5a0afdc1642473a57d. DO NOT EDIT.
...
var getScriptTargetFeatures = memoize(func() ScriptTargetFeatures {
...
func getNewTargetContainer(node Node) * /* TODO(TS-TO-GO) inferred type FunctionDeclaration | ConstructorDeclaration | FunctionExpression */ any {
...
func getExternalModuleRequireArgument(node Node) /* TODO(TS-TO-GO) inferred type false | StringLiteral */ any {
...
func getNameOrArgument(expr /* TODO(TS-TO-GO) TypeNode UnionType: PropertyAccessExpression | LiteralLikeElementAccessExpression */ any) /* TODO(TS-TO-GO) inferred type MemberName | (Expression & (NumericLiteral | StringLiteralLike)) */ any {
...
func getEffectiveContainerForJSDocTemplateTag(node JSDocTemplateTag) * /* TODO(TS-TO-GO) inferred type SignatureDeclaration | JSDocCallbackTag | JSDocEnumTag | JSDocTypedefTag */ any {
...
func getDeclarationEmitExtensionForPath(path string) /* TODO(TS-TO-GO) inferred type Extension.Dts | Extension.Dmts | Extension.Dcts | ".d.json.ts" */ any {
	switch {
...
func emitDetachedComments(text string, lineMap []number, writer EmitTextWriter, writeComment func(text string, lineMap []number, writer EmitTextWriter, commentPos number, commentEnd number, newLine string), node TextRange, newLine string, removeComments bool) * /* TODO(TS-TO-GO) inferred type { nodePos: number; detachedCommentEndPos: number; } */ any {
...
var computedOptions = createComputedCompilerOptions(map[any]any{ /* TODO(TS-TO-GO): was object literal */
	...
	"module": map[any]any{ /* TODO(TS-TO-GO): was object literal */
		...
		"computeValue": func(compilerOptions /* TODO(TS-TO-GO) inferred type Pick<CompilerOptions, "module" | "target"> */ any) ModuleKind {
			...
			case computedOptions.target.computeValue(compilerOptions) >= ScriptTargetES2015:
	...
	"moduleDetection": map[any]any{ /* TODO(TS-TO-GO): was object literal */
		...
		"computeValue": func(compilerOptions /* TODO(TS-TO-GO) inferred type Pick<CompilerOptions, "module" | "moduleDetection" | "target"> */ any) ModuleDetectionKind {
			return compilerOptions.moduleDetection || (__COND__(computedOptions.module.computeValue(compilerOptions) == ModuleKindNode16 || computedOptions.module.computeValue(compilerOptions) == ModuleKindNodeNext, ModuleDetectionKindForce, ModuleDetectionKindAuto))
		},
	},
	"isolatedModules": map[any]any{ /* TODO(TS-TO-GO): was object literal */
		...
		"computeValue": func(compilerOptions /* TODO(TS-TO-GO) inferred type Pick<CompilerOptions, "isolatedModules" | "verbatimModuleSyntax"> */ any) bool {
	...
	"allowSyntheticDefaultImports": map[any]any{ /* TODO(TS-TO-GO): was object literal */
		...
		"computeValue": func(compilerOptions /* TODO(TS-TO-GO) inferred type Pick<CompilerOptions, "allowSyntheticDefaultImports" | "module" | "moduleResolution" | "target"> */ any) bool {
			...
			return computedOptions.esModuleInterop.computeValue(compilerOptions) || computedOptions.module.computeValue(compilerOptions) == ModuleKindSystem || computedOptions.moduleResolution.computeValue(compilerOptions) == ModuleResolutionKindBundler
		},
	},
	"resolvePackageJsonExports": map[any]any{ /* TODO(TS-TO-GO): was object literal */
		...
		"computeValue": func(compilerOptions /* TODO(TS-TO-GO) inferred type Pick<CompilerOptions, "moduleResolution" | "resolvePackageJsonExports"> */ any) bool {
			moduleResolution := computedOptions.moduleResolution.computeValue(compilerOptions)
	...
	"resolveJsonModule": map[any]any{ /* TODO(TS-TO-GO): was object literal */
		...
		"computeValue": func(compilerOptions /* TODO(TS-TO-GO) inferred type Pick<CompilerOptions, "module" | "moduleResolution" | "target" | "resolveJsonModule"> */ any) bool {
			...
			return computedOptions.moduleResolution.computeValue(compilerOptions) == ModuleResolutionKindBundler
		},
	},
	...
	"preserveConstEnums": map[any]any{ /* TODO(TS-TO-GO): was object literal */
		"dependencies": [] /* TODO(TS-TO-GO) inferred type "isolatedModules" | "verbatimModuleSyntax" */ any{"isolatedModules", "verbatimModuleSyntax"},
		"computeValue": func(compilerOptions /* TODO(TS-TO-GO) inferred type Pick<CompilerOptions, "isolatedModules" | "preserveConstEnums" | "verbatimModuleSyntax"> */ any) bool {
	...
	"useDefineForClassFields": map[any]any{ /* TODO(TS-TO-GO): was object literal */
		...
		"computeValue": func(compilerOptions /* TODO(TS-TO-GO) inferred type Pick<CompilerOptions, "module" | "target" | "useDefineForClassFields"> */ any) bool {
			if compilerOptions.useDefineForClassFields == nil {
				return computedOptions.target.computeValue(compilerOptions) >= ScriptTargetES2022
			} else {
...
func createPropertyNameNodeForIdentifierOrLiteral(name string, target ScriptTarget, singleQuote bool, stringNamed bool, isMethod bool) /* TODO(TS-TO-GO) inferred type StringLiteral | Identifier | NumericLiteral */ any {
...
func createEvaluator(TODO_IDENTIFIER EvaluationResolver) /* TODO(TS-TO-GO) inferred type { (expr: TemplateExpression, location?: Declaration): EvaluatorResult<string | undefined>; (expr: Expression, location?: Declaration): EvaluatorResult; } */ any {
...
func createNameResolver(TODO_IDENTIFIER /* TODO(TS-TO-GO) TypeNode TypeLiteral: { compilerOptions: CompilerOptions; getSymbolOfDeclaration: (node: Declaration) => Symbol; error: (location: Node | undefined, message: DiagnosticMessage, ...args: DiagnosticArguments) => void; globals: SymbolTable; argumentsSymbol: Symbol; requireSymbol: Symbol; lookup: (symbols: SymbolTable, name: __String, meaning: SymbolFlags) => Symbol | undefined; setRequiresScopeChangeCache: undefined | ((node: FunctionLikeDeclaration, value: boolean) => void); getRequiresScopeChangeCache: undefined | ((node: FunctionLikeDeclaration) => boolean | undefined); onPropertyWithInvalidInitializer?: (location: Node | undefined, name: __String, declaration: PropertyDeclaration, result: Symbol | undefined) => boolean; onFailedToResolveSymbol?: ( location: Node | undefined, name: __String | Identifier, meaning: SymbolFlags, nameNotFoundMessage: DiagnosticMessage, ) => void; onSuccessfullyResolvedSymbol?: ( location: Node | undefined, result: Symbol, meaning: SymbolFlags, lastLocation: Node | undefined, associatedDeclarationForContainingInitializerOrBindingName: ParameterDeclaration | BindingElement | undefined, withinDeferredContext: boolean, ) => void; } */ any) * /* TODO(TS-TO-GO) inferred type (location: Node | undefined, nameArg: __String | Identifier, meaning: SymbolFlags, nameNotFoundMessage: DiagnosticMessage | undefined, isUse: boolean, excludeGlobals?: boolean) => Symbol */ any {
	/* eslint-disable no-var */
...
var unprefixedNodeCoreModules = NewSet(unprefixedNodeCoreModulesList)
...
var exclusivelyPrefixedNodeCoreModules = NewSet([]string{"node:sea", "node:sqlite", "node:test", "node:test/reporters"})

/** @internal */

var nodeCoreModules = NewSet([]string{ /* TODO(TS-TO-GO) Node SpreadElement: ...unprefixedNodeCoreModulesList */ /* TODO(TS-TO-GO) Node SpreadElement: ...unprefixedNodeCoreModulesList.map(name => `node:${name}`) */ /* TODO(TS-TO-GO) Node SpreadElement: ...exclusivelyPrefixedNodeCoreModules */ })
